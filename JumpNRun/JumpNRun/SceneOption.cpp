...
bool SceneOption::setupResources()
{
	...
	colorCheckbox = addResource<CheckBox*>("CheckBox", new CheckBox([&](bool checked, ObjectBase* sender) { this->checkAction(checked, sender); }, new DrawableShape<RectangleShape>()));
	...
	otherCheckbox = addResource<CheckBox*>("otherBox", new CheckBox([&](bool checked, ObjectBase* sender) { this->otherAction(); }, new DrawableShape<RectangleShape>()));
